...
\begin{itemize}
  \item \textbf{H1}: Die Verbreitung visueller und audiovisueller Desinformation auf Social-Media-Plattformen in der Schweiz hat in den letzten Jahren zugenommen. Insbesondere während Krisenzeiten (beispielsweise Covid19-Pandemie, Ukraine-Konflikt, Israel-Konflikt, …) ist ein Anstieg bemerkbar.
  ...
  \item \textbf{H7}:  Desinformative Inhalte werden aus einem bestimmten Grund verbreitet.
  \item \textbf{H8}:  Desinformative Videos enthalten viele Schnitte, um die Zuschauerbindung zu erhöhen.
\end{itemize}
...
Insgesamt wurden 164 Artikel von Keystone-SDA, 98 Artikel von AFP und 27 Artikel von 20 Minuten erfasst. Davon ausgehend können 385 Social-Media-Beiträge ausgewertet werden.
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|c|c|c|}
    ...
    \hline
    \textbf{\# fVar 91, 92} & 33 & 93 & 17 \\
    \hline
    \textbf{\# Ohne CH-Bezug} & 6 & 25 & 39 \\
    \hline
    \textbf{\# Duplikate} & 2 & 2 & 0 \\
    \hline
    \textbf{\# bereinigt} & 146 & 223 & 16 \\
    \hline
    \multicolumn{4}{|c|}{Total: 385} \\
    \hline
  \end{tabular}
...
\pagebreak
\section{Ergebnisse}
Anhand einer quantitativen Inhaltsanalyse wurden die Produktion und Funktionsweise visueller und audiovisueller Desinformation auf Social-Media-Plattformen mit Schweizbezug untersucht.
Für die Auswertung wurde der JSON-Datensatz in R analysiert. Dabei wurden primär relative Häufigkeitsauswertungen, Kreuztabellen und Pearson's \(\chi^2\)-Tests durchgeführt, um die Hypothesen zu beantworten. Für jede Auswertung werden die verwendeten Auswertungsmethoden separat beschrieben.\\ Die Ergebnisse dieser quantitativen Analyse werden im Folgenden ausgeführt.

% Metadaten-Auswertung
\subsection{Metadaten-Auswertung}
...
\textbf{Quelle und Landesbezug}
% Häufigkeitsauswertung via Kreuztabelle
% Modus
% Darstellung: Blasendiagramm: Herkunftsland⁄Bezugsland
...
\end{quote}
% - Themen/Aufkommen hängen mit Daten zusammen
% - x^2-Test of Independence: https://www.scribbr.com/statistics/chi-square-test-of-independence/
% - StdResiduals
...
% - x^2: Koherenz zwischen Post-Sentiment und Visual-Sentiment;
% - cohens kappa: Kleine Koherenz
...
\begin{quote}
  ...
  \(H_{0_4}\): Desinformationen wird durch Einzelpersonen und Kollektivakteure gleichermassen verbreitet. Die gesellschaftlichen Rollen sind gleichmässig verteilt.
\end{quote}
% - Häufigkeitsverteilung
% - x^2 zwischen Akteurstyp und gesellschaftlicher Rolle
...
\begin{quote}
  ...
  \(H_{0_6}\): Beitragstexte und Artefakte sind gleichermassen desinformativ.
\end{quote}
% - Häufigkeitsverteilung
% - Thematik des Artefakts: Häufigkeitsverteilung
% -  X2 Beitragsthema / Thematik des Artefakts

\textbf{Hypothese 7}:
\begin{quote}
  \(H_7\): Desinformative Inhalte werden aus einem bestimmten Grund verbreitet.\\
  \(H_{0_7}\): Es ist kein bestimmter Verbreitungsgrund erkennbar.
\end{quote}

\textbf{Hypothese 8}:
\begin{quote}
  \(H_8\): Desinformative Videos enthalten viele Schnitte, um die Zuschauerbindung zu erhöhen. \\
