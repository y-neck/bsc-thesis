...
\begin{itemize}
  ...
  \item \textbf{H4}: Desinformation wird oft von Einzelpersonen weiterverbreitet. In den meisten Fällen handelt es sich beim Ursprung/den Produzierenden des Artefakts um offizielle Quellen (Journalismus oder Politik).
...
\\ Auch liefert die angewandte Methode keine Aussage über das tatsächliche Ausmass von visueller und audiovisueller Desinformation in der Schweiz. Es lässt sich nicht feststellen, wie gross die Grundgesamtheit aller desinformativer Beiträge auf Social-Media-Plattformen mit Schweizbezug ist.
...
Für die Auswertung wird der JSON-Datensatz in R analysiert. Dabei werden relative Häufigkeitsauswertungen, Kreuztabellen und \(\chi^2\)-Tests durchgeführt, um die Hypothesen zu beantworten.
% P-Value
