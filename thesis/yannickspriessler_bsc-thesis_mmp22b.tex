...
\end{table}
Von den untersuchten Spitzenabweichungen korrelieren einige mit aktuellen Vorkommnissen, andere haben keinen direkten Bezug zu aktuellen Ereignissen. Aus der Inhaltsverteilung über den Zeitstrahl (s. \ref{fig:results_date_dependency} \nameref{fig:results_date_dependency}) lassen sich gewisse Ereignis-Berichtstendenzen ableiten.
