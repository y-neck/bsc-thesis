...
\begin{table}[H]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|l|l|l|} \hline
      \textbf{Ursprungsplattform} & \textbf{Anzahl Beiträge n} & \textbf{Relative Häufigkeit \({h_n}{x_i}\)} \\ \hline
...
\begin{table}[H]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|l|l|l|} \hline
      \textbf{Themengebiet des Beitrags} & \textbf{Anzahl Beiträge n} & \textbf{Relative Häufigkeit \({h_n}{x_i}\)} \\ \hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|c|c|c|} \hline
    \textbf{Thema}&  \textbf{Datum}&  \textbf{z-Wert}& \textbf{Beschreibung der Desinformation} \\ \hline
...
\end{table}
Von den untersuchten Spitzenabweichungen korrelierten einige mit aktuellen Vorkommnissen, andere hatten keinen direkten Bezug zu aktuellen Ereignissen. Aus der Inhaltsverteilung über den Zeitstrahl (s. \ref{fig:results_date_dependency} \nameref{fig:results_date_dependency}) liessen sich gewisse Ereignis-Berichtstendenzen ableiten und prüfen:  so bezog sich beispielsweise der aussergewöhnlich starke Ausschlag im Thema Politik anfangs 2024 auf desinformierende Berichterstattung über das World Economics Forum.
...
Durch Zählung der Beiträge mit Keywords und Gruppierung in Themen wurde der mittlere Anteil an Beiträgen mit Keyword pro Thema und somit die Wahrscheinlichkeit für jedes Thema errechnet, dass ein zugehöriger Beitrag Keywords enthält:
\begin{table}[H]
  \centering
  \resizebox{\textwidth}{!}{
  \begin{tabular}{|c|c|c|c|} \hline
    \textbf{Thema}&  \textbf{n Beiträge}&  \textbf{n Beiträge mit Keyword}& \textbf{Wahrscheinlichkeit p}\\ \hline
 ...
 Nicht erkennbar& 9& 0&0\\\hline
  \end{tabular}}
  \caption{Statistische Wahrscheinlichkeit pro Themenbeitrag, ein Keyword zu enthalten}
...
\end{quote}
Die Häufigkeitsverteilung der Akteurstypen ergab, dass es sich in etwa drei Viertel (Modus; 74,28 \%) der Fälle um Privatpersonen handelt, welche die Desinformation auf Social Media teilen. Bei 4,21 \% handelte es sich um Kollektivakteure, der Rest ist nicht klar erkennbar.
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{images/actor_plot.png}
    \caption{Relative Häufigkeit der Akteursrollen innerhalb der Akteurstypen}
...
Zusätzlich wurden für jede Akteursrolle und jedes Thema die Standardresiduen errechnet, um eine Aussage darüber zu treffen, inwiefern Akteure (beispielsweise Politiker und Politikerinnen) Beiträge über das zugehörige Thema (Politik) veröffentlichen. Positive Werte zeigen eine Tendenz, besonders oft über ein Thema zu berichten, negative Werte implizieren eine Vermeidung. Als statistisch signifikanter Grenzwert wurde \(\pm\) 2.0 angenommen.
\begin{table}[H]
    \centering
    ...
    \end{tabular}
    \caption{Statistisch signifikante Tendenzen pro gesellschaftliche Rolle, über ein Thema zu berichten.}
    \label{tab:role_topic_stdres}
\end{table}
...
\begin{figure}[H]
    \raggedright\caption{\textit{Häufigkeitsverteilung der Artefakt-Typen}}
...
\end{figure}
Den anteilsmässig grössten Teil der visuellen Artefakte machten, wie in Abbildung 5 erkennbar, eigens erstellte Grafiken aus (Modus; 46,98 \%). Darunter zählen beispielsweise Memes, rein textbasierte Bilder oder Fotos mit Begleittext. \\ 
