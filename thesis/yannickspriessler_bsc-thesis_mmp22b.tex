...
% Biases (Lazer, Stark)
Die Literatur kennt verschiedene Arten von Biases. \textcite{lazer_science_2018} nennen in Zusammenhang mit Desinformation die Folgenden:
\begin{itemize}
...
\end{itemize}
Von Biases wird angenommen, dass sie die Verarbeitung von Informationen ebenfalls vereinfachen, was weiter in einer erhöhten Angriffsfläche für Desinformation resultiert \parencite[5]{tandoc_jr_facts_2019}.

Krafft 195

% Filterblasen (Zoglauer, Stark:222, Krafft:195)



% - Auswirkungen\\
% - Wer verbreitet Desinformation?\\ -> Guess, 
